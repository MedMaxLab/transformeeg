...
if __name__ == '__main__':
    ...
    part_c = split.create_nested_kfold_subject_split(ctl_id_5, 10, 10)
    part_p = split.create_nested_kfold_subject_split(pds_id_5, 10, 10)
    ...
    part_c = split.create_nested_kfold_subject_split(ctl_id_8, 10, 10)
    part_p = split.create_nested_kfold_subject_split(pds_id_8, 10, 10)
    partition_list_2 = split.merge_partition_lists(part_c, part_p, 10, 10)

    #ds004148
    partition_list_3 = split.create_nested_kfold_subject_split(60,10,10)

    #ds004584
    pds_id_19 = [i for i in range(1, 101)]
    ctl_id_19 = [i for i in range(101, 141)]
    part_c = split.create_nested_kfold_subject_split(ctl_id_19, 10, 10)
    part_p = split.create_nested_kfold_subject_split(pds_id_19, 10, 10)
    partition_list_4 = split.merge_partition_lists(part_c, part_p, 10, 10)
